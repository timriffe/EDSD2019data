...
We're going to wrangle a UN-compiled spreadsheet with tons of fertility data. We can get it here. This will require some filtering to get the valid subsets, a reshape operation, and then let's try to graduate these rates to single ages using Schmertmann's method, which I can give you code for.
